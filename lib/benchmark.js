...
var M_thin = allocate(1000000).map(function () {
	return random(3);
});
var M_eq = allocate(1000000).map(function () {
	return 7;
});
...
var impl_M_thin = make_sort_benchmark('impl_M_thin', M_thin, _3.default).run();
var impl_M_eq = make_sort_benchmark('impl_M_eq', M_eq, _3.default).run();
...
var control_M_thin = make_sort_benchmark('control_M_thin', M_thin, inplace_nativesort).run();
var control_M_eq = make_sort_benchmark('control_M_eq', M_eq, inplace_nativesort).run();
